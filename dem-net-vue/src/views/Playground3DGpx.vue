        ...
        <div class="container is-fluild">
            ...
            <div class="card">
                <header class="card-header">
                    <p class="card-header-title">Upload a GPX file&nbsp;>&nbsp;Choose your options&nbsp;>&nbsp;Generate
                ...
                <div class="card-content">
                    ...
                    {{ gpxFile.name }}
                            ...
                            <div class="columns">
                                ...
                                <div class="column">
                                    ...
                                    <b-field>
                                        ...
                                        <b-radio-button v-model="requestParams.format" native-value="glTF">Binary glTF
                                        </b-radio-button>
                                        <b-radio-button v-model="requestParams.format" native-value="STL">STL (3D
                                            printer)
                                        </b-radio-button>
                                    </b-field>
                                </div>
                                ...
                                <div class="column">
                                    <b-field label="Z multiplier">
                                        <b-slider v-model="requestParams.zFactor" size="is-medium" :min="1" :max="10"
                                                  :step=".5"></b-slider>
                                    </b-field>
                                </div>
                                <!-- TIN -->
                            ...
                            <div class="buttons is-centered">
                                ...
                                <!-- Generation -->
                                <b-button @click="upload" :disabled="!gpxFile" icon-pack="fas"
...
export default {
    ...
    components: {ThreeDviewer, DatasetSelector, ImagerySelector, Attributions},
    mounted() {
