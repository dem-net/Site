                                ...
                                <div class="column">
                                    <div class="columns">
                                        ...
                                        <div class="column">
                                            ...
                                            <b-field>
                                                <b-radio-button v-model="requestParams.format" native-value="glTF">
                                                    Binary glTF
                                                </b-radio-button>
                                                <b-radio-button v-model="requestParams.format" native-value="STL">STL
                                                </b-radio-button>
                                            </b-field>
                                        </div>
                                    </div>
                                    <div class="columns">
                                        ...
                                        <div class="column">
                                            <b-field label="Z multiplier">
                                                <b-slider v-model="requestParams.zFactor" size="is-medium" :min="1"
                                                          :max="10" :step=".5"></b-slider>
                                            </b-field>
                                        </div>
                                        <!-- TIN-->
...
export default {
    ...
    components: {ThreeDviewer, MapRectangle, DatasetSelector, ImagerySelector, Attributions},
    mounted() {
